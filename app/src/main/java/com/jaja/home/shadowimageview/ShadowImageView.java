 ...
 */
package com.jaja.home.shadowimageview;
...
import com.yinglan.shadowimageview.*;
...
public class ShadowImageView extends RelativeLayout {
    ...
    private void initView(Context context, AttributeSet attrs) {
        ...
        int imageresource = -1;
        if (attrs != null) {
            TypedArray a = context.obtainStyledAttributes(attrs, com.yinglan.shadowimageview.R.styleable.ShadowImageView);
            if (a.hasValue(com.yinglan.shadowimageview.R.styleable.ShadowImageView_shadowSrc)) {
                imageresource = a.getResourceId(com.yinglan.shadowimageview.R.styleable.ShadowImageView_shadowSrc, -1);
            }
            shadowRound = a.getDimensionPixelSize(com.yinglan.shadowimageview.R.styleable.ShadowImageView_shadowRound, shadowRound);
            if (a.hasValue(com.yinglan.shadowimageview.R.styleable.ShadowImageView_shadowColor)) {
                shadowColor = a.getColor(com.yinglan.shadowimageview.R.styleable.ShadowImageView_shadowColor, Color.parseColor("#8D8D8D"));
            }
        } else {
        ...
        com.yinglan.shadowimageview.RoundImageView roundImageView = new com.yinglan.shadowimageview.RoundImageView(context);
        ...
        getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                ((com.yinglan.shadowimageview.RoundImageView) getChildAt(0)).setRound(shadowRound);
                mInvalidat = true;
            }
        });
    }
    ...
    public void setImageResource(int resId) {
        ((com.yinglan.shadowimageview.RoundImageView) getChildAt(0)).setImageResource(resId);
        invalidate();
        mInvalidat = true;
    }

    public void setImageDrawable(Drawable drawable) {
        ((com.yinglan.shadowimageview.RoundImageView) getChildAt(0)).setImageDrawable(drawable);
        invalidate();
        mInvalidat = true;
    }

    public void setImageBitmap(Bitmap bitmap) {
        ((com.yinglan.shadowimageview.RoundImageView) getChildAt(0)).setImageBitmap(bitmap);
        invalidate();
        mInvalidat = true;
    }
